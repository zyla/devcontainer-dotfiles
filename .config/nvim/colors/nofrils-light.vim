...
" Modified to look good on e-ink screen
...
hi LineNr term=NONE cterm=NONE ctermfg=248 ctermbg=NONE gui=NONE guifg=#A8A8A8 guibg=NONE
...
hi PmenuSel term=NONE cterm=reverse,bold ctermfg=NONE ctermbg=NONE gui=NONE guifg=fg guibg=#FF00FF
...
hi Include term=NONE cterm=bold ctermfg=NONE ctermbg=NONE gui=NONE guifg=NONE guibg=NONE
...
hi Operator term=NONE cterm=NONE ctermfg=2 ctermbg=NONE gui=NONE guifg=NONE guibg=NONE
...
function! NofrilsFocusComments()
    ...
    hi Normal term=NONE cterm=NONE ctermfg=248 ctermbg=NONE gui=NONE guifg=#000000 guibg=#E4E4E4
    hi LineNr term=NONE cterm=NONE ctermfg=248 ctermbg=NONE gui=NONE guifg=#A8A8A8 guibg=NONE
    hi Character term=NONE cterm=NONE ctermfg=NONE ctermbg=NONE gui=NONE guifg=NONE guibg=NONE
    hi String term=NONE cterm=NONE ctermfg=NONE ctermbg=NONE gui=NONE guifg=NONE guibg=NONE

    if g:nofrils_heavycomments
        hi Comment term=NONE cterm=NONE ctermfg=59 ctermbg=NONE gui=NONE guifg=#87005F guibg=NONE
    end
endfunction
